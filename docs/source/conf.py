...
release = get_version('microcalorimetry')
...
print('latest minors', latest_minors)
if not latest_minors:
    smv_tag_whitelist = None
else:
    smv_tag_whitelist = '|'.join(
        ['^' + t.replace('.', r'\.') + '$' for t in latest_minors]
    )
print('tag whitelist', smv_tag_whitelist)
